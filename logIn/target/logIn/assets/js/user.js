...
var viewExmsBtn;    //button to see the exams
...
window.addEventListener('load', ()=>{
    ...
    viewExmsBtn=document.createElement('button');
    ...
    viewExmsBtn.addEventListener('click', viewExams);
    viewRandevouz.addEventListener('click', viewUsersRandevouz);
    ...
    viewExmsBtn.innerHTML="View Exams";
...
function showUser(){
    ...
    columnBtnContainer.append(viewExmsBtn);
...
function showTreatment(){
    ...
    usrBackBtn.addEventListener('click', viewExams);
    if(trtObj===null){
        main.innerHTML="";
        div=document.createElement('div');
